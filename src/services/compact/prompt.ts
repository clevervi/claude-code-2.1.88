 ...
 * This version uses robust regexes to handle missing closing tags (truncation)
 * and optional whitespace inside tags.
 * 
...
export function formatCompactSummary(summary: string): string {
  ...
  // Regex handles missing closing tags at end of string and is case-insensitive.
  ...
  // Captures content even if closing tag is missing (truncation) or case differs.
  ...
  if (summaryMatch) {
    ...
    // Replace the entire <summary> block (including leading XML tag) with a header
    formattedSummary = formattedSummary.replace(
